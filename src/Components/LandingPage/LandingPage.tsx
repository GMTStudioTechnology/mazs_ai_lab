    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-black">
        ...
        <div className="relative text-center text-white px-4 max-w-5xl mx-auto">
          <h2 className="text-6xl md:text-8xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-white to-indigo-300">
            Mazs AI v1.5.0 anatra 
          </h2>
          <p className="text-xl md:text-2xl mb-12 text-white/80 font-light max-w-3xl mx-auto leading-relaxed">
            Made by GMTStudio, for the future.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link to="/MazsAI" className="group px-8 py-4 bg-white text-black text-lg font-medium rounded-full hover:bg-white/90 transition relative overflow-hidden">
            ...
            <a href="#features" className="px-8 py-4 border border-white/30 text-white text-lg font-medium rounded-full hover:bg-white/10 transition backdrop-blur-sm">
              Learn More
            </a>
          </div>
        </div> 
      ...
      <section id="features" className="py-32 bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h3 className="text-5xl font-bold text-white mt-4">Intelligent(?  Solutions</h3>
            <p className="text-xl text-white/70 mt-6 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={index} className="group p-8 bg-white/5 backdrop-blur-xl rounded-2xl hover:bg-white/10 transition-all duration-300">
                <div className="bg-gradient-to-br from-indigo-500 to-purple-500 rounded-xl p-4 w-16 h-16 mb-6 text-white">
                  {feature.icon}
                </div>
      ...
      {/* About Section */}
      <section id="about" className="py-32 bg-gradient-to-b from-black to-indigo-900">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <span className="text-indigo-400 font-medium text-sm uppercase tracking-wider">About Us</span>
              <h3 className="text-5xl font-bold text-white">Redefining Possibilities</h3>
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="bg-white/5 backdrop-blur-xl p-6 rounded-2xl">
                  <h4 className="text-3xl font-bold text-indigo-400">about 1 Mb</h4>
                  <p className="text-white/70 mt-2">super light weight</p>
                </div>
                <div className="bg-white/5 backdrop-blur-xl p-6 rounded-2xl">
                  <h4 className="text-3xl font-bold text-indigo-400">24/7</h4>
                  <p className="text-white/70 mt-2">Always online</p>
                </div>
              </div>
            </div>
            <div className="relative">
              <img src={mazsai} alt="AI Technology" className="rounded-2xl shadow-2xl" />
              <div className="absolute -bottom-8 -right-8 bg-gradient-to-r from-indigo-500 to-purple-500 text-white p-8 rounded-2xl shadow-xl">
                <p className="text-xl font-medium">Only 4610 parameters</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h3 className="text-5xl font-bold text-white mt-4">Success Stories</h3>
          </div>
            ...
            {[
              ...
              <div key={index} className="group p-8 bg-white/5 backdrop-blur-xl rounded-2xl hover:bg-white/10 transition-all duration-300">
                <div className="flex items-center mb-6">
                  <img src={testimonial.image} alt={testimonial.name} className="w-14 h-14 rounded-full ring-2 ring-indigo-500" />
                  <div className="ml-4">
                    <h5 className="text-lg font-medium text-white">{testimonial.name}</h5>
      ...
      {/* Footer */}
      <footer className="bg-black/90 backdrop-blur-xl text-white/70 py-16 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  <a key={index} href={social.href} className="text-white/70 hover:text-white transition">
